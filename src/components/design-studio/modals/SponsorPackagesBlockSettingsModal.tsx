      ...
      >
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '24px 28px', borderBottom: '1px solid #F3F4F6' }}>
          <div>
            <h2 style={{ fontSize: '20px', fontWeight: 800, color: '#111827', marginBottom: '4px' }}>
              Sponsor Packages Settings
            </h2>
            <p style={{ fontSize: '13px', color: '#6B7280' }}>
              Configure your available sponsorship opportunities.
            </p>
          </div>
          <button 
            onClick={onClose} 
        ...
        <form onSubmit={handleSubmit} style={{ padding: '28px', overflowY: 'auto' }}>
          ...
          <div style={{ marginBottom: '24px' }}>
            ...
            <div style={{ marginBottom: '16px' }}>
              ...
              <input
                ...
                placeholder="e.g., Sponsorship Opportunities"
              />
            </div>
          ...
          <div style={{ marginBottom: '24px' }}>
            ...
            <div>
              <label style={{ display: 'block', fontSize: '12px', fontWeight: 600, color: '#6B7280', marginBottom: '4px' }}>Highlighted Package ID (to show 'Most Popular')</label>
              <input
