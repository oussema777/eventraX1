...
export const countries: CountryOption[] = [
  ...
  { code: 'CA', name: "Canada", phoneCode: '+1204' },
  ...
  { code: 'TF', name: "French Southern and Antarctic Lands", phoneCode: '+262' },
  ...
  { code: 'KZ', name: "Kazakhstan", phoneCode: '+76' },
  ...
  { code: 'PN', name: "Pitcairn Islands", phoneCode: '+64' },
  ...
  { code: 'RU', name: "Russia", phoneCode: '+73' },
