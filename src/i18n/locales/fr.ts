      ...
      step3: {
        ...
        sessions: {
          ...
          modal: {
            ...
            scheduleTitle: 'Quand cette session a-t-elle lieu ?',
            selectEventDay: 'Choisissez un jour pour votre session',
            date: 'Date *',
            ...
            cancel: 'Annuler',
            capacity: 'Combien de personnes peuvent participer ?',
            capacityUnlimited: 'Pas de limite',
        ...
        customForms: {
          ...
          formTypes: {
            ...
            feedback: 'Retour',
            evaluation: 'Evaluation post-evenement',
            quiz: 'Quiz / Test de connaissances',
            poll: 'Sondage / Vote',
            nomination: 'Nomination',
            pitch: 'Soumission de pitch',
            checkin: 'Pointage',
            interest: "Manifestation d'interet",
